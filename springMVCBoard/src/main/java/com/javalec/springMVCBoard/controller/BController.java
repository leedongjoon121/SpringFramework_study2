...
public class BController {
	...
	private JdbcTemplate template;  // JDBC Template 추가 !
	
	@Autowired // 자동으로 빈이 생성되서 할당 되게 한다.  : servlet-context.xml의 DataSource를 할당해줌 
	public void setTemplate(JdbcTemplate template) { // template setter 메서드   => 
		this.template = template;
		Constant.template = this.template;   // Constant라는 클래스의 util 이용
	}
